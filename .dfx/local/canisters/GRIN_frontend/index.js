...
import { idlFactory } from './GRIN_frontend.did.js';
export { idlFactory } from './GRIN_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_GRIN_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./GRIN_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the GRIN_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./GRIN_frontend.did.js")._SERVICE>}
 */
export const GRIN_frontend = createActor(canisterId);
